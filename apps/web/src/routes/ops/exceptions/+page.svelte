<script lang="ts">
	...
	type Item = { id:string; kind:string; state:string; booking_id:string|null; payment_attempt_id:string|null; provider_deadline:string|null; amount_minor:number|null; currency:string|null; reason:string; created_at:string };
