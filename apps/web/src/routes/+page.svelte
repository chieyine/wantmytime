...
<div class="brand-home">
	...
	<section class="brand-method" id="how" bind:this={methodSection} style={`--method-progress: ${methodProgress}`}><div class="brand-method-title"><p>THE METHOD / 01—03</p><h2>SAY YES<br />WITHOUT<br /><i>BEING USED.</i></h2></div><div class="brand-method-steps"><article class:active={activeStep === 0}><span>01</span><div><h3>NAME YOUR PRICE</h3><p>Decide what 15, 30 or 60 minutes of you costs, or let people make an offer. Open only the hours you want to give.</p></div></article><article class:active={activeStep === 1}><span>02</span><div><h3>DROP YOUR LINK</h3><p>Bio, email signature, DMs. The next time someone asks “can I pick your brain?”, you have a one-line answer.</p></div></article><article class:active={activeStep === 2}><span>03</span><div><h3>GET PAID</h3><p>They pay before the call. We hold the money, and it reaches your bank about three hours after you hang up. No chasing anyone.</p></div></article></div></section>
	<section class="brand-fee"><p>YOUR LINK / 60 SECONDS</p><div><h2>STOP<br />GIVING IT<br />AWAY.</h2><div><p class="brand-fee-lead">Your time already has a price. Now people can pay it.</p><a class="brand-fee-cta" href="/claim">CLAIM YOUR LINK <span aria-hidden="true">↗</span></a><p>Free to set up. We keep 5% of each paid booking and nothing else. <a href="/pricing">How pricing works</a></p></div></div></section>
</div>
